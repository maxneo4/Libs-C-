...
namespace Bizagi.Deployment.RestServices.Lib change namespace according code is located
{
    public class MetricYourAppLog
{
    ...
    public static MetricYourAppLog Last { get; set; }
    ...
    private async void AppendAllTextToCloudLog(string logPath, string text)
    {
