...
namespace SharedMemoryConsole
{
    class Program
    {
        ...
        private static void TestRestSharedMemory()
        {
            ...
            SharedMemoryRest.WriteEvent("hola mundo\r\n");
            SharedMemoryRest.WriteEvent("otro evento\r\n");
            SharedMemoryRest.WriteEvent("evento final\r\n");
            SharedMemoryRest.WriteEvent("cat", 56);
            SharedMemoryRest.WriteEvent("CAtalog", "Bizagi", "Un valor pequeñop");
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                SharedMemoryRest.WriteEvent("Other", "Custom" + i, @"2022-04-08 08:54:23 BIZAGI UPGRADER LOG ----- INFORMATION -- UpdateAsyncTaskTime
...
2022-04-08 08:54:24 BIZAGI UPGRADER LOG ----- INFORMATION -- End: Upgrading database FlujoPAMDesa on server MAXPC\SQL2019DEV...");
           ...
           SharedMemoryRest.SetVar("sl", 445);
           SharedMemoryRest.WriteEvent("newF", "vars", SharedMemoryRest.GetVars());

           //varsMemory.ClearVars();           
           SharedMemoryRest.SetVar("new", 4545);
        }
